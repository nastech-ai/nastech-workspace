# Contributing to NasTech Workspace
...
3. Set up environment:
   ```bash
   cp .env.example .env
   # Edit .env — set NASTECH_API_URL (default: http://127.0.0.1:8642)
   ```
4. Start [NasTech Agent](https://github.com/nastech-ai/nastech-agent) API server
...
- `NASTECH_API_URL` — NasTech Agent gateway backend (default: `http://127.0.0.1:8642`)
