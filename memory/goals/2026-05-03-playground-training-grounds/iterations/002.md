...
- Updated NasTech-facing lore/copy across Athena, Iris, Dorian, and Forge ritual text to better explain NasTech Agent, docs/memory/context/recall, starter-kit progression, and the Forge framing.
...
- Requested per-slice commits: blocked in this sandbox because Git cannot write `.../.git/worktrees/nastech-playground-local/index.lock`
