...
Commit: `e2ff6bb05` (mouse fix) + `c9268f77a` (NasTech/knight theming) — local-only
...
### NasTech / knight theming
- **NasTechStatue** — winged-petasos hero centerpiece with chlamys cape, caduceus staff, and winged sandals. Glowing inscription ring at the base. Anchors **Training Grounds** + **Agora Commons**.
- **PracticeDummy + WeaponRack** — wooden practice dummies with stitched X-faces and racks holding spear/sword/NasTech-shield. Lined up around the **Trainer's Ring** (3 dummies + 2 racks).
- **NasTechBanner** — pole + colored cloth + winged sigil dot. Flanks the Forge Gate (Training Grounds), Arrival Circle, Agora colonnade entrances (4), Forge entry (2), and Arena gates (4).
...
- **NasTech (Arena referee)** — winged petasos, breastplate disc, glowing chlamys cape, caduceus staff in offhand, hip sword sheath.
...
### 1. Training Grounds — "First steps with a NasTech Agent"
**What it teaches:** core onboarding loop — talk to NPCs, equip gear, pick up your first quest, complete the NasTech tutorial chain (move/talk → equip → chat → archive/docs → forge build).

**Showcase moves:**
- Open on the **NasTech statue** at center. Slow camera orbit (right-click drag).
...
**Talking points:** "This is the NasTech Agent onboarding — every quest maps to a real NasTech concept: prompts, memory, docs, building, deploying."
...
**Showcase moves:**
- Open on the **NasTech statue + colonnade** with banners at the 4 entrances and braziers around the statue.
...
**What it teaches:** combat / evaluation world. Nike (Champion), NasTech (Referee, fully knighted with caduceus), Chronos (Bookmaker).
...
- NasTech the Referee should now look unmistakably mythic — petasos + cape + caduceus.
...
7. End on the **NasTech statue** with banners + braziers, slow zoom out
