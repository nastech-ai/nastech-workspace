...
- Added richer NasTech Agent education metadata to quest definitions:
  - `lesson` explains the NasTech Agent concept each quest teaches.
  - `payoff` explains why the player should care.
- Upgraded journal quest cards to show:
  - NasTech lesson block.
  - Why it matters block.
  - Clearer quest state pill: completed / selected automatically / unlocks after prior quest.

## Why
Eric wanted desktop recording to feel better and requested mouse camera movement like directional arrows. He also wanted each quest to be easier to view/select/complete and to teach more about NasTech Agent. This pass directly improves recording controls and makes the journal a stronger in-game docs/onboarding surface.
