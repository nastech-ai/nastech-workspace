# NasTech Workspace Naming Contract

This repo is for **NasTech Workspace** and **NasTech Agent** work.
...
- `claude`
- NasTech worker sessions

Do not suggest Claude-specific runtime wrappers or profile paths for live NasTech Workspace behavior.
...
- **NasTech Workspace** and **NasTech Agent** in update/config/status UI

Avoid:
- person-specific product labels baked into UI
- Claude-branded wording in NasTech Workspace surfaces

## Reviewer rule

Any PR or patch that introduces new Claude-branded naming into NasTech Workspace should be treated as a regression unless it is:
