# NasTechWorld — Master Plan (Single Source of Truth)
...
NasTechWorld = the first **Agentic MMO**.
...
- **Marketing/store page spec**: `docs/nastechworld/reference-images/MASTER-PRODUCT-GRAPHIC.png`
- **Playable in-game spec**: `docs/nastechworld/reference-images/INGAME-TARGET-AGORA.png`
...
- `nastech-ai/nastech-workspace` — public (browser game lives here)
- `nastech-ai/nastechworld-game` — **private** (issues, internal specs, prize logic, secrets, roadmap)
- `nastech-ai/controlsuite` — desktop client
- `ocplatform/ocplatform` — agent runtime
- `ocplatform/ocplatform-control-ui` — webchat surface

## 5. Asset replacement waves (right order)

We replace NasTechWorld's art batch by batch, never all at once.
...
3. Private repo `nastech-ai/nastechworld-game` created with labels + issue templates
...
5. Name reservation page (form on nastech-world.ai)
...
| Goal ID | File | State |
| --- | --- | --- |
| 2026-05-06-nastechworld-swarm-game-studio | `memory/goals/2026-05-06-nastechworld-swarm-game-studio/` | active |
| 2026-05-06-nastechworld-master-plan | this file | active |

When new goals are spawned, register them here so future agents see them.

## 8. Existing companion docs

- `docs/nastechworld/INGAME-TARGET-SPEC.md` — playable view target breakdown
- `docs/nastechworld/AGENTIC-WOW-ROHAN-SYSTEMS.md` — class/skill/raid systems
- `docs/nastechworld/GUILDS-AGENTS-COMPANION-ECONOMY.md` — guild + agent + monetization
- `docs/nastechworld/VISION-BEST-AI-MMO.md` — north star
- `docs/nastechworld/ART-BIBLE-REALISM-LOOP.md` — image gen → review loop
- `docs/nastechworld/AGORA-INSO-IMPLEMENTATION.md` — Agora hub upgrade plan
- `docs/nastechworld/AGORA-INSO-ASSET-PROMPTS.md` — concrete prompt pack
- `skills/video-game-building/` — reusable game-build skill

## 9. Bug + community input pipeline

- Public face: `nastech-world.ai/feedback` form
...
1. Read this file.
2. Read `docs/nastechworld/MASTER-PRODUCT-GRAPHIC.png`.
3. Read `memory/goals/2026-05-06-nastechworld-swarm-game-studio/goal.spec.md` and `state.json`.
