...
function SkillsWidget({
  ...
  // Summary view per NasTech Agent feedback: 'don’t enumerate, summarise.'
...
export function DashboardScreen() {
  ...
  // NasTech dashboard exposes (status, platforms, cron, achievements,
  ...
  return (
    <div className="min-h-full">
      ...
      {/* ── Header: brand lockup left, action cluster right.
           ...
           page IS the dashboard); promoted "NasTech Workspace" to
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        {/* Action row: hierarchy per NasTech Agent review.
