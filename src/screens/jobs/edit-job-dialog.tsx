          ...
          >
            ...
            >
              <div>
                ...
                >
                  Update the schedule, prompt, and routing for this NasTech task.
                </p>
              </div>
              <button
                type="button"
            ...
            <div className="flex-1 space-y-5 overflow-y-auto px-5 py-4">
              <section className="space-y-2">
                ...
                {job.profile && form.profile !== job.profile ? (
                  ...
                  <p
                    ...
                    style={{ color: 'var(--theme-muted)' }}
                  >
                    Cron jobs are stored under the selected NasTech profile.
                  </p>
                )}
              </section>
              ...
              <section className="space-y-2">
                ...
                <textarea
                  ...
                  placeholder="What should NasTech Agent do?"
                  required
                  rows={5}
                    ...
                    {DELIVERY_OPTIONS.map((option) => {
                      ...
                      return (
                        <button
                          ...
                          title={
                            needsGateway
                              ? `Requires NasTech Agent gateway with ${option} configured`
                              : undefined
                          }
