...
const NASTECH_REPO_URL = 'https://github.com/nastech-ai/nastech-workspace'
const NASTECH_ROADMAP_URL = 'https://github.com/nastech-ai/nastech-workspace/blob/main/docs/nastechworld/master-roadmap.md'
const NASTECH_DOCS_URL = 'https://github.com/nastech-ai/nastech-workspace/tree/main/docs/nastechworld'
const NASTECH_FEATURES_URL = 'https://github.com/nastech-ai/nastech-workspace/blob/main/FEATURES-INVENTORY.md'
...
const capabilities = [
  ...
  { label: 'NasTech Sigils', copy: 'Make invisible agent progress visible and collectible.', icon: '⚚' },
...
const todayDrops = [
  ['Landing Page', 'A cinematic share surface for the NasTechWorld reveal.'],
...
export function NasTechWorldLanding() {
  return (
      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-82px)] w-full max-w-[1560px] items-center gap-10 px-4 pb-12 pt-8 sm:px-6 lg:grid-cols-[0.78fr_1.22fr] lg:px-8 lg:pb-18 lg:pt-10">
        <div className="relative z-10 max-w-2xl lg:pl-2">
          ...
          <p className="mt-7 max-w-xl text-pretty text-lg leading-8 text-[#d7d0bd]/72 sm:text-xl">
            NasTechWorld turns agents into companions inside a persistent world. Explore zones, complete quests, collect sigils, and watch agents keep working while the world keeps moving.
          </p>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <a href={NASTECH_REPO_URL} {...externalLinkProps} className="inline-flex items-center justify-center rounded-xl border border-[#d9b35f]/24 bg-[#0b1118]/78 px-6 py-4 text-sm font-black uppercase tracking-[0.14em] text-[#f8e4ac] shadow-[inset_0_1px_0_rgba(255,255,255,.08)] backdrop-blur-xl transition hover:border-[#d9b35f]/50 hover:bg-[#121823]">
              View on GitHub
            </a>
            <a href={NASTECH_DOCS_URL} {...externalLinkProps} className="inline-flex items-center justify-center rounded-xl border border-[#d9b35f]/24 bg-[#0b1118]/78 px-6 py-4 text-sm font-black uppercase tracking-[0.14em] text-[#f8e4ac] shadow-[inset_0_1px_0_rgba(255,255,255,.08)] backdrop-blur-xl transition hover:border-[#d9b35f]/50 hover:bg-[#121823]">
              Read Docs
            </a>
          </div>
          ...
          <div className="mt-7 max-w-xl rounded-2xl border border-[#d9b35f]/18 bg-[#05080e]/70 p-4 shadow-[0_20px_70px_rgba(0,0,0,.28),inset_0_1px_0_rgba(255,255,255,.06)] backdrop-blur-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="mt-1 text-sm font-bold leading-5 text-[#fff6df]">NasTechWorld landing page, roadmap, feature list, and the first public build notes.</div>
              </div>
            </div>
          </div>
        </div>
...
function Header() {
  return (
    <header className="relative z-30 mx-auto mt-4 flex max-w-[1560px] items-center justify-between border-b border-[#d9b35f]/20 px-4 pb-4 sm:px-6 lg:px-8">
      <a href="/nastech-world" className="flex items-center gap-3">
        <img src="/nastechworld-logo.svg" alt="NasTechWorld" className="h-10 w-10 rounded-2xl shadow-[0_0_34px_rgba(34,211,238,.18)]" />
        <div>
          <div className="font-serif text-lg font-bold tracking-[-0.03em] text-[#f8e4ac]">NasTech<span className="text-cyan-200">World</span></div>
      ...
      <nav className="hidden items-center gap-8 text-[11px] font-black uppercase tracking-[0.18em] text-[#d7d0bd]/58 md:flex">
        ...
        <a href={NASTECH_DOCS_URL} {...externalLinkProps} className="transition hover:text-[#f8e4ac]">Docs</a>
        ...
        <a href={NASTECH_REPO_URL} {...externalLinkProps} className="rounded-lg border border-[#d9b35f]/30 bg-[#d9b35f]/10 px-4 py-2 text-[#f8e4ac] shadow-[0_0_30px_rgba(217,179,95,.08)] transition hover:bg-[#d9b35f]/18">GitHub</a>
      </nav>
    </header>
  )
}
      ...
      <div className="relative overflow-hidden rounded-[1.65rem] border border-[#d9b35f]/34 bg-[#05080e] p-2 shadow-[0_50px_160px_rgba(0,0,0,.72),0_0_80px_rgba(217,179,95,.12)]">
        ...
        <div className="relative aspect-[16/10] overflow-hidden rounded-[1.15rem] bg-[#0a1117]">
          ...
          <div className="absolute left-4 top-4 rounded-xl border border-[#d9b35f]/24 bg-[#05080e]/70 px-3 py-2 shadow-2xl backdrop-blur-xl">
            <div className="text-[9px] font-black uppercase tracking-[0.2em] text-[#f8e4ac]/70">NasTechWorld Entry</div>
    ...
    <section id="agents" className="relative border-y border-[#d9b35f]/14 bg-[#061016]/72 px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-[1440px] gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div>
          ...
          <p className="mt-5 max-w-xl text-base leading-8 text-[#d7d0bd]/62">NasTechWorld turns agents into visible companions. They can follow, take quests, report progress, and eventually move through the world on their own.</p>
      ...
      <div className="grid gap-8 rounded-[2rem] border border-[#d9b35f]/22 bg-[radial-gradient(circle_at_32%_42%,rgba(217,179,95,.22),transparent_34%),#071018] p-5 shadow-[0_40px_140px_rgba(0,0,0,.45)] md:grid-cols-[0.9fr_1.1fr] md:p-8 lg:p-10">
        <div className="relative flex min-h-[360px] items-center justify-center overflow-hidden rounded-[1.35rem] border border-[#d9b35f]/18 bg-[#04070c]">
          ...
          <div className="relative flex h-56 w-56 items-center justify-center rounded-full border border-[#d9b35f]/42 bg-[radial-gradient(circle,#f8e4ac_0%,#d9b35f_22%,#4b3516_68%,#120d08_100%)] shadow-[0_0_90px_rgba(217,179,95,.32)]">
            <img src="/nastechworld-logo.svg" alt="NasTech Sigil" loading="lazy" decoding="async" className="h-36 w-36 rounded-[2rem] shadow-[0_0_40px_rgba(34,211,238,.18)]" />
          </div>
        </div>

        <div className="flex flex-col justify-center">
          <div className="text-[11px] font-black uppercase tracking-[0.24em] text-[#d9b35f]/72">In-world progression</div>
          <h2 className="mt-3 font-serif text-4xl font-bold tracking-[-0.055em] text-[#fff6df] sm:text-6xl">Collect NasTech Sigils as you unlock the world.</h2>
          <p className="mt-5 text-base leading-8 text-[#d7d0bd]/62">NasTech Sigils are progression artifacts earned through quests, agent upgrades, world exploration, and system mastery. They make invisible agent progress visible.</p>
...
function FinalCta() {
  return (
    <section className="relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8">
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(180deg,rgba(3,6,10,.18),#03060a),url('/nastechworld-world.png')] bg-cover bg-center opacity-45" />
      ...
      <div className="mx-auto max-w-[880px] rounded-[2rem] border border-[#d9b35f]/24 bg-[#05080e]/78 p-8 text-center shadow-[0_40px_140px_rgba(0,0,0,.52)] backdrop-blur-xl sm:p-12">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-[#d7d0bd]/62">Enter NasTechWorld and explore the first playable layer of NasTech Workspace: zones, quests, companions, sigils, and persistent agent progression.</p>
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          ...
          <a href={NASTECH_DOCS_URL} {...externalLinkProps} className="rounded-xl border border-white/12 bg-white/[0.055] px-7 py-4 text-sm font-black uppercase tracking-[0.14em] text-white/78 transition hover:bg-white/[0.1]">Read Docs</a>
          <a href={NASTECH_REPO_URL} {...externalLinkProps} className="rounded-xl border border-white/12 bg-white/[0.055] px-7 py-4 text-sm font-black uppercase tracking-[0.14em] text-white/78 transition hover:bg-white/[0.1]">View GitHub</a>
          <a href={NASTECH_ROADMAP_URL} {...externalLinkProps} className="rounded-xl border border-white/12 bg-white/[0.055] px-7 py-4 text-sm font-black uppercase tracking-[0.14em] text-white/78 transition hover:bg-white/[0.1]">Read Roadmap</a>
        </div>
      </div>
    </section>
  )
...
function Footer() {
  return (
    <footer className="mx-auto flex max-w-[1560px] flex-col gap-4 border-t border-[#d9b35f]/14 px-4 py-8 text-xs text-[#d7d0bd]/42 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
      <div className="flex items-center gap-3">
        <img src="/nastechworld-logo.svg" alt="NasTechWorld" loading="lazy" decoding="async" className="h-8 w-8 rounded-xl" />
        <span className="font-serif text-base text-[#f8e4ac]">NasTech<span className="text-cyan-200">World</span></span>
      </div>
      <div className="flex flex-wrap gap-4 uppercase tracking-[0.16em]">
        <a href={NASTECH_REPO_URL} {...externalLinkProps} className="hover:text-[#f8e4ac]">GitHub</a>
        <a href={NASTECH_DOCS_URL} {...externalLinkProps} className="hover:text-[#f8e4ac]">Docs</a>
        <a href={NASTECH_ROADMAP_URL} {...externalLinkProps} className="hover:text-[#f8e4ac]">Roadmap</a>
        <a href={NASTECH_FEATURES_URL} {...externalLinkProps} className="hover:text-[#f8e4ac]">Feature List</a>
