...
describe('mergeModelEntries', () => {
  it('keeps local catalog entries and appends NasTech backend models without duplicates', () => {
    const merged = mergeModelEntries(
      ...
      [
        { id: 'openai/gpt-4.1', name: 'GPT-4.1 from NasTech', provider: 'openai' },
  ...
  it('normalizes string model ids from NasTech-compatible /v1/models responses', () => {
